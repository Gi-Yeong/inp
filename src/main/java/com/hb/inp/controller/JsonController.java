...
//            VM70 전송 부분
			...
			for (int i = 0; i < paramInfoArray70.size(); i++) {
				...
				System.out.print((String) paramObj.get("j_number :"));
				dto.setJ_code((String) paramObj.get("j_code"));
				System.out.print((String) paramObj.get("j_code :"));
				dto.setJ_title((String) paramObj.get("j_title"));
				System.out.print((String) paramObj.get("j_title :"));
				dto.setJ_schk((String) paramObj.get("j_schk"));
				System.out.print((String) paramObj.get("j_schk :"));
				dto.setJ_date((String) paramObj.get("j_date"));
				System.out.print((String) paramObj.get("j_date :"));
				dto.setJ_time((String) paramObj.get("j_time"));
				System.out.print((String) paramObj.get("j_time :"));
				dto.setJ_memo1((String) paramObj.get("j_memo1"));
				System.out.print((String) paramObj.get("j_memo1 :"));
				dto.setJ_no(Integer.parseInt((String) paramObj.get("j_no")));
				System.out.print(Integer.parseInt((String) paramObj.get("j_no :")));
				dto.setJ_gunsu(Integer.parseInt((String) paramObj.get("j_gunsu")));
				System.out.print(Integer.parseInt((String) paramObj.get("j_gunsu :")));
				dto.setJ_money1(Integer.parseInt((String) paramObj.get("j_money1")));
				System.out.print(Integer.parseInt((String) paramObj.get("j_money1 :")));
				dto.setJ_money2(Integer.parseInt((String) paramObj.get("j_money2")));
				System.out.print(Integer.parseInt((String) paramObj.get("j_money2 :")));
				dto.setJ_money3(Integer.parseInt((String) paramObj.get("j_money3")));
				System.out.print(Integer.parseInt((String) paramObj.get("j_money3 :")));
				dto.setJ_money4(Integer.parseInt((String) paramObj.get("j_money4")));
				System.out.print(Integer.parseInt((String) paramObj.get("j_money4 :")));
				dto.setJ_money5(Integer.parseInt((String) paramObj.get("j_money5")));
				System.out.print(Integer.parseInt((String) paramObj.get("j_money5 :")));
				dto.setJ_money6(Integer.parseInt((String) paramObj.get("j_money6")));
				System.out.print(Integer.parseInt((String) paramObj.get("j_money6 :")));
